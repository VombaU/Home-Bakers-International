    ...
    public class RecipeService : IRecipeService
    {
        ...
        public RecipeService()
        {
            _recipes.Add(new Recipe {
                ...
                ThumbnailUrl = "https://www.kingarthurbaking.com/sites/default/files/styles/featured_image/public/2021-07/Rustic-Sourdough-Loaf_0049__0.jpg?itok=ZpXUOjJR",
                Rating = 4.5,
            ...
            _recipes.Add(new Recipe {
                ...
                ThumbnailUrl = "https://www.bakersdelight.com.au/wp-content/uploads/2018/10/New-Croissant.jpg",
                Rating = 3.5,
                UploadDate = DateTime.Now,
                Cuisine = "Romanian",
                DoughType = "Pastry",
            ...
            _recipes.Add(new Recipe {
                ...
                ThumbnailUrl = "https://www.sugarsaltmagic.com/wp-content/uploads/2023/01/Turkish-Flatbread-Bazlama-2FEAT-500x500.jpg",
                Rating = 5.0,
                UploadDate = DateTime.Now,
                Cuisine = "Turkish",
                DoughType = "Flatbread",
